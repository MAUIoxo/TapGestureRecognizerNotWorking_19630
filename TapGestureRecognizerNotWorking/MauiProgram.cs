...
using TapGestureRecognizerNotWorking.Pages;
using TapGestureRecognizerNotWorking.Pages.Views;
using TapGestureRecognizerNotWorking.ViewModels;
using Microsoft.Extensions.Logging;
using Sharpnado.CollectionView;
using Sharpnado.Tabs;

namespace TapGestureRecognizerNotWorking
{
